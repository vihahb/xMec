...
//    final String name, final long birthDay, final double hegiht, final double weight, String urlAvatar
    ...
    public void checkUpdateProfile(final String name, final long birthDay, final double hegiht, final double weight, String urlAvatar){
        if (!checkConnnecttion(view))
            return;
        updateProfile(UPDATEPROFILE,name,birthDay,hegiht,weight,urlAvatar);
    }
